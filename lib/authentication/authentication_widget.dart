        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/1_P1070582-768x1024.jpg',
              ).image,
            ),
          ),
          child: Container(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'AUTHENTICATION_PAGE_Button-Login_ON_TAP');
                                            logFirebaseEvent(
                                                'Button-Login_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'AUTHENTICATION_Container_t6ap0kgy_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_auth');
                                                GoRouter.of(context)
                                                    .prepareAuthEvent();
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'AUTHENTICATION_CREATE_ACCOUNT_BTN_ON_TAP');
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'AUTHENTICATION_Container_7dnaoetx_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_auth');
                                                GoRouter.of(context)
                                                    .prepareAuthEvent();
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'AUTHENTICATION_Container_av4xxdvm_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_auth');
                                                GoRouter.of(context)
                                                    .prepareAuthEvent();
