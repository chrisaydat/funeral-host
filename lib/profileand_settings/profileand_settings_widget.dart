...
import 'profileand_settings_model.dart';
export 'profileand_settings_model.dart';

class ProfileandSettingsWidget extends StatefulWidget {
  const ProfileandSettingsWidget({Key? key}) : super(key: key);

  @override
  _ProfileandSettingsWidgetState createState() =>
...
class _ProfileandSettingsWidgetState extends State<ProfileandSettingsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ProfileandSettings'});
              ...
              children: [
                if (Theme.of(context).brightness == Brightness.light)
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'PROFILEAND_SETTINGS_isLightMode_ON_TAP');
                ...
                if (Theme.of(context).brightness == Brightness.dark)
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('PROFILEAND_SETTINGS_isDarkMode_ON_TAP');
